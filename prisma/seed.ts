  ...
  const events = await Promise.all([
    ...
    prisma.event.create({
      data: {
        ...
        description: 'Annual charity ride to raise funds for local children\'s hospital. All riders welcome!',
        type: 'public',
      },
    }),
    prisma.event.create({
  ...
  await Promise.all([
    ...
    prisma.rule.create({
      data: {
        ...
        description: 'When riding as a group, maintain staggered formation and follow the road captain\'s signals.',
        category: 'riding',
        order: 3,
      },
    }),
